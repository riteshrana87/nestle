$(document).ready(function () {
    ...
    /* Start - Set Installetion Date and its validation*/
    /*
    ...
    getVersionDetails(versionNumber); // on page load call function for get version data
    ...
    $.ajax({
        ...
        success: function (resultData) {
            ...
            if (versionObj != '') {
                ...
                // $('#version').html(versionObj.versionData.version_name);
