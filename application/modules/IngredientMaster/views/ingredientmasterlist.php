...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Ingredient Master</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        &nbsp;
                        <?php if (checkPermission('IngredientMaster', 'add')) { ?>
                        <div class="pull-right">
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/addcategory'); ?>">Add Ingredient</a>
                        </div>
                        <?php }?>
                    </div>
