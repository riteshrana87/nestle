        ...
        <tr>
            ...
            <td><?php echo $data['status'];?></td>
                <td class="text-center">
                    ...
                    <?php if(checkPermission('IngredientMaster','edit')){ ?>
                        <a class="btn btn-link" href="<?php echo base_url($crnt_view.'/edit/'.$data['cat_id']);?>" title="<?= lang('edit')?>">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>
                    <?php }?>
                    <?php if(checkPermission("IngredientMaster","delete")){?><a class="btn btn-link" data-href="javascript:;" title="<?= lang('delete')?>" onclick="delete_request(<?php echo $data['cat_id']; ?>);" ><i class="fa fa-trash-o" aria-hidden="true"></i></a><?php } ?></td>
        </tr>
        <?php } ?>
        <?php } else { ?>
            <tr>
