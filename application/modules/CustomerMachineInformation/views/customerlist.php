...
?>
<script>
    var deleteCustomerURL = "<?php echo base_url('CustomerMachineInformation/deleteAssignedMachineToCustomer'); ?>";
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Customer Master - Back Office</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
