...
//pr($data['campaign_info']);exit;
    ...
    public function insertdata() {
        ...
        if (isset($duplicateName) && empty($duplicateName) && $getcount == 0) {
            ...
            $data = array(
                ...
                'memberof' => $this->input->post('memberof')
            );
    ...
    public function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $fields = array("l.login_id, l.firstname, l.lastname, l.email, l.password, l.address,l.position, l.mobile_number, l.role_id, l.created_date, l.status, l.memberof");
