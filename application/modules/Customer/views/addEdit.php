...
<script>
    ...
    var versionNumber = "<?php echo (isset($editVersion) ? $editVersion : ''); ?>";
    var check_customer_code_url = "<?php echo base_url('Customer/isDuplicateCustomerCode'); ?>";
</script>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php if (isset($editCustomerCode) && !empty($editCustomerCode)) { ?>
                                                    <?= !empty($editCustomerCode) ? $editCustomerCode : '' ?>
                                                <?php } else { ?>
                                                    <input class="form-control" id="customer_code" name="customer_code" autocomplete="false" placeholder="Enter customer Code" data-parsley-trigger="change" data-parsley-required-message="Please Enter Customer Code" data-parsley-maxlength="100" data-parsley-maxlength-message ='Max. 100 Characters are allowed.' data-parsley-trigger="keyup" type="text" value=""  data-parsley-code />
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label col-sm-3 required">Emirate</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label col-sm-3 required">Payment Terms</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" id='payment_terms' name='payment_terms' required='true' data-parsley-required-message="Please Select Payment Terms">
                                                    <option value=''>Select Payment Terms</option>
                                                    <?php
                                                    foreach ($paymentTermsList as $paymentTermsData) {
                                                        echo "<option value='" . $paymentTermsData['id'] . "' " . set_select('payment_terms', (isset($editPaymentTermsId) ? $editPaymentTermsId : ''), $paymentTermsData['id'] == (isset($editPaymentTermsId) ? $editPaymentTermsId : '')) . ">" . $paymentTermsData['name'] . " - " . $paymentTermsData['description'] . "</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
