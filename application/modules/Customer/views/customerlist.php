...
?>
<script>
    var deleteCustomerURL = "<?php echo base_url('Customer/deleteCustomer'); ?>";
</script>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Customer Master - Sales Person</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <?php if (checkPermission('Customer', 'add')) { ?>
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add'); ?>">Add Customer</a>
                            <?php } ?>
                        </div>
                    </div>
