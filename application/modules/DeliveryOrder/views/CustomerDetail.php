...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <span id='customer_email' name='customer_email'><?= !empty($customer_info[0]['email']) ? $customer_info[0]['email'] : $this->lang->line('NA'); ?></span>
        </div>
    </div>
</div>
<div class="clearfix"></div>
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <span id='customer_name' name='customer_name'>
                <?= !empty($customer_info[0]['machine_serial_number']) ? $customer_info[0]['machine_serial_number'] : $this->lang->line('NA'); ?>
            </span>
        </div>
    </div>
</div>