...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Delivery Order List</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Delivery Order List
                        <?php if (checkPermission('DeliveryOrder', 'add')) { ?>
                            <div class="pull-right">
                                <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add_record'); ?>">Add Delivery Order</a>
                            </div>
                        <?php }?>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="whitebox" id="common_div">
                            <?php $this->load->view('DeliveryOrderAjaxList'); ?>
