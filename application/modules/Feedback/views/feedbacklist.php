...
?>
<script>
    var deleteFeedBackURL = "<?php echo base_url('Feedback/deleteFeedback'); ?>";
</script>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Feedback List</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <?php if (checkPermission('Feedback', 'add')) { ?>
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add'); ?>">Add Feedback</a>
                            <?php } ?>
                        </div>
                    </div>
