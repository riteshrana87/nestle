...
?>
<script>
    var deleteMaintenanceURL = "<?php echo base_url($crnt_view . '/deleteMaintenance'); ?>";
</script>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Maintenance Listing - Sales Person</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Maintenance Listing - Sales Person
                        <div class="pull-right">
                            <?php if(checkPermission('Maintenance','add')){ ?>
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add'); ?>">Add Maintenance - Sales Person</a>
                            <?php } ?>
                        </div>
                    </div>
