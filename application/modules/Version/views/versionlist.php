...
?>
<script>
    //var deleteVersion = "<?php //echo base_url('Version/delete'); ?>";
    var changeStatusURL = "<?php echo base_url('Version/changeStatus'); ?>";
</script>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Version Master</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <?php if(checkPermission('Version','add')){ ?>
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add'); ?>">Add Version</a>
                            <?php }?>
                        </div>
                    </div>
