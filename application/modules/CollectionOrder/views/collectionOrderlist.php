...
?>
<script>
    var deleteCollectionOrderURL = "<?php echo base_url('CollectionOrder/deleteCollection'); ?>";
</script>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Collection Order Listing</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Collection Order Listing
                        <div class="pull-right">
                            <?php if(checkPermission("CollectionOrder","add")){?>
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add'); ?>">Add Collection Order</a>
                            <?php } ?>
                        </div>
                    </div>
