...
?>
<script>
    var deleteInventoryURL = "<?php echo base_url('Inventory/deleteInventory'); ?>";
</script>
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line"><?=$this->lang->line('machine_inventory_listing')?></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <?php if (checkPermission('Inventory', 'add')) { ?>
                            <a class="btn btn-primary" href="<?php echo base_url($crnt_view . '/add'); ?>"><?=$this->lang->line('btn_machine_inventory')?></a>
                            <?php } ?>
                        </div>
                    </div>
