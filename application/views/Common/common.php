        ...
        $(document).on('change', '#machine_menu_file', function (evt, params) {
            ...
            if (typeof (FileReader) !== "undefined") {
                ...
                if (validFileData) {
                    ...
                    reader.onload = function (e) {
                        var img = $(fileInfo.name + '<a href="javascript:void(0);" class="removePreviewFile" onclick="removePreviewFileMenu();">X</a>');
    ...
    $('body').on('click', '#common_tb ul.pagination a.ajax_paging', function (e) {
        ...
        $.ajax({
            ...
            data: {
                ...
                start_date: $("input[name=start_date]").val(), end_date: $("input[name=end_date]").val(), report_type: $('#report_type').val(), report_status: $('#report_status').val()
            },
            /*
             beforeSend: function () {
